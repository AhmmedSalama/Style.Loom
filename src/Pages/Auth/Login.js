        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100 p-4">
            <div className="w-full max-w-5xl bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2 gap-0">
                    {/* Welcome Section */}
                    <div className="bg-gradient-to-br from-[rgb(174,155,132)] via-[rgb(164,145,122)] to-[rgb(154,135,112)] p-12 flex flex-col justify-center items-center text-white">
                        <div className="text-center space-y-6">
                            <h1 className="text-4xl font-bold tracking-tight text-white">Welcome Back!</h1>
                            <p className="text-white/90 text-lg leading-relaxed">
                                Don't have an account? Sign up now to join us!
                            </p>
                            <Link 
    to="/Register" 
    ...
    Sign up
                    ...
                    <div className="p-12 flex flex-col justify-center bg-white">
                        <form className="space-y-6" onSubmit={HanldeSubmit}>
                            <h1 className="text-4xl font-bold text-[rgb(174,155,132)] mb-8">Login</h1>
